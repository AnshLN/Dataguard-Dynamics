          ...
          return{
            CMSMenuEditData:{
                breadcrumbs: [
                    ...
                    { name: 'Clone', path: '/admin/cms/appearance/menu/clone'}                   //follow the sequence of breadcrumbs , last item of breadcrumbs will remain ACTIVE
                ],
                caption_icon: 'fa fa-clone',
                caption_title: 'CLONE MENU',
                action_links:[ 
                ]
            },
            FormData:{
